...
export const SettingsIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6 mr-2" }) => (
...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6 mr-2" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const CpuChipIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6 mr-2" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 21v-1.5M15.75 3v1.5m0 16.5v-1.5m3.75-12h-1.5m0 12h-1.5m-12-3.75h1.5m12 0h1.5m-12-3.75h1.5m3.75 0h1.5m-3.75 0h1.5m3.75 0h1.5m-3.75 0h1.5m-15-3.75h1.5m3.75 0h1.5m-3.75 0h1.5m3.75 0h1.5M6.75 12a.75.75 0 0 1 .75-.75h9a.75.75 0 0 1 0 1.5h-9a.75.75 0 0 1-.75-.75Z" />
    </svg>
);
...
export const ArrowPathIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 11.667 0l3.181-3.183m-11.667-11.667a8.25 8.25 0 0 1 11.667 0l3.181 3.183m-14.85-3.183L2.985 16.65M16.023 9.348A8.25 8.25 0 0 1 21.015 16.65" />
    </svg>
);
